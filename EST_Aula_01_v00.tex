...
% ------------------------------------------------------------------------
\begin{frame}[t,fragile=singleslide]
\frametitle{De uma seleção de dados}
	\begin{tikzpicture}[remember picture,overlay]
...
\frametitle{Representações bivariadas}
	\begin{tikzpicture}[remember picture,overlay]
	\node[xshift=7.5cm,yshift=3.5cm,opacity=1.0] at (current page.center) {\includegraphics[width=18cm]{scatter_plot_02.png}};
	\end{tikzpicture}
	\vspace{-1.5cm}
	\begin{itemize}
...
\frametitle{Algumas definições}
	...
	\vspace{0.5cm}
	\begin{tikzpicture}[remember picture,overlay]
	\node[xshift=9.5cm,yshift=2cm,opacity=1.0] at (current page.center) {\includegraphics[width=12cm]{monty-hall.png}};
	\end{tikzpicture}
	\vfill

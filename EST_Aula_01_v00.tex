...
\frametitle{Proporção}
	...
	\begin{align*}
		...
		\hat{s}^2_{\mu} &= \frac{\hat{s}^2}{N} = \sqrt{\frac{\hat{p} \cdot (1 - \hat{p})}{N}}\\
		N &= \hat{p} \cdot (1 - \hat{p}) \left( \frac{Z_\alpha}{M} \right)^2
	\end{align*}
	\begin{equation*}
		Z_{\frac{\alpha}{2}} \cdot \hat{s}^2_{\mu} \leq \pi \leq Z_{1-\frac{\alpha}{2}} \cdot \hat{s}^2_{\mu}
	\end{equation*}
...
\frametitle{Média}
	...
	\begin{columns}[T] % align columns
		\begin{column}{.48\textwidth}
			...
			\end{align*}
			\begin{equation*}
			t_{(\frac{\alpha}{2},N-1)} \cdot \hat{s}^2_{\mu} \leq \mu \leq t_{(1-\frac{\alpha}{2},N-1)} \cdot \hat{s}^2_{\mu}
			\end{equation*}
		\end{column}		
		\begin{column}{.48\textwidth}
